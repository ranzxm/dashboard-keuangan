...
CREATE TYPE "public"."wallet_type" AS ENUM('cash', 'bank', 'e-wallet', 'other');--> statement-breakpoint
...
CREATE UNIQUE INDEX "budgets_user_month_category_active_idx" ON "budgets" USING btree ("user_id","month","category") WHERE "budgets"."deleted_at" is null;--> statement-breakpoint
...
CREATE UNIQUE INDEX "wallets_user_name_active_idx" ON "wallets" USING btree ("user_id","name") WHERE "wallets"."deleted_at" is null;